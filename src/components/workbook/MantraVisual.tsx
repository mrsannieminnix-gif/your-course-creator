...
const MantraVisual = ({ mantraId }: MantraVisualProps) => {
  ...
  if (mantraId === "prep-your-child") {
    return (
      <div className="my-4 print:my-1 flex flex-col items-center">
        <div className="bg-gradient-to-br from-teal-500 to-cyan-600 rounded-3xl p-5 print:p-3 shadow-2xl text-center max-w-xl w-full print:max-w-none">
          <div className="w-14 h-14 print:w-10 print:h-10 mx-auto mb-2 print:mb-1 bg-white/20 rounded-full flex items-center justify-center border-4 border-white/30">
            <span className="text-3xl print:text-xl">🗺️</span>
          </div>
          <h3 className="font-serif text-2xl print:text-xl font-bold text-white mb-1 tracking-wide">PREP YOUR CHILD</h3>
          <div className="w-12 h-0.5 bg-white/50 mx-auto mb-2 print:mb-1" />
          <p className="text-white/90 text-base print:text-[11px] italic mb-3 print:mb-2 leading-snug">"Most kids don't like surprises—help them know what's coming"</p>

          <div className="space-y-3 print:space-y-0 print:grid print:grid-cols-2 print:gap-2">
            {/* Why Prep Matters */}
            <div className="bg-white/20 rounded-xl p-4 print:p-2 text-left">
              <h4 className="text-white font-bold text-lg print:text-sm mb-2 print:mb-1 flex items-center gap-2">
                <span className="text-xl print:text-sm">💡</span> Why Prep Matters
              </h4>
              <div className="space-y-1 text-white/90 text-sm print:text-[9px] leading-tight">
            ...
            <div className="bg-white/20 rounded-xl p-4 print:p-2 text-left">
              <h4 className="text-white font-bold text-lg print:text-sm mb-2 print:mb-1 flex items-center gap-2">
                <span className="text-xl print:text-sm">🛝</span> Going to the Playground
              </h4>
              <div className="bg-white/10 rounded-lg p-3 print:p-1.5 text-white/90 text-sm print:text-[8px] italic leading-tight">
                <p>"We're going to the playground! We will be kind to new friends and take turns.</p>
                <p className="mt-1">I'll give you a 5-minute warning when it's time to go.</p>
                <p className="mt-1">We'll leave with a grateful heart. If we can't leave with ease, we'll take a break from the park.</p>
                <p className="mt-1 font-semibold">Are you ready to go have fun?"</p>
              </div>
            </div>
            ...
            <div className="bg-white/20 rounded-xl p-4 print:p-2 text-left">
              <h4 className="text-white font-bold text-lg print:text-sm mb-2 print:mb-1 flex items-center gap-2">
                <span className="text-xl print:text-sm">🏫</span> School Drop-Off
              </h4>
              <div className="bg-white/10 rounded-lg p-3 print:p-1.5 text-white/90 text-sm print:text-[8px] italic leading-tight">
                <p>"I'm going to drop you off and give you a big hug and kiss.</p>
                <p className="mt-1">It might be sad to say goodbye, and that's okay!</p>
                <p className="mt-1 font-semibold">But I will be back to pick you up with another big hug and kiss."</p>
              </div>
            </div>
            ...
            <div className="bg-white/20 rounded-xl p-4 print:p-2 text-left">
              <h4 className="text-white font-bold text-lg print:text-sm mb-2 print:mb-1 flex items-center gap-2">
                <span className="text-xl print:text-sm">✅</span> What to Include
              </h4>
              <div className="space-y-1 text-white/90 text-sm print:text-[9px] leading-tight">
          ...
          {/* Faith Element */}
          <div className="mt-3 print:mt-1 pt-2 print:pt-1 border-t border-white/30">
            <div className="flex items-center gap-3 print:gap-2 bg-white/20 rounded-xl p-3 print:p-1.5">
              <img
                src={faithImageMap["jesus-foundation"]}
                alt="God prepares the way"
                className="w-12 h-12 print:w-8 print:h-8 rounded-full object-cover border-2 border-white/50 shadow-lg"
              />
              <div className="flex-1 text-left">
                <p className="text-white font-serif text-sm print:text-[9px] italic leading-tight">
                  "I will instruct you and teach you in the way you should go."
                </p>
                <p className="text-white/70 text-xs print:text-[8px] mt-0.5">— Psalm 32:8</p>
              </div>
            </div>
          </div>
        </div>
  ...
  if (mantraId === "your-25-year-old") {
    return (
      <div className="my-4 print:my-1 flex flex-col items-center">
        <div className="bg-gradient-to-br from-slate-600 to-slate-800 rounded-3xl p-5 print:p-3 shadow-2xl text-center max-w-xl w-full print:max-w-none">
          {/* Icon */}
          <div className="w-14 h-14 print:w-10 print:h-10 mx-auto mb-2 print:mb-1 bg-amber-400 rounded-full flex items-center justify-center border-4 border-amber-300 shadow-lg">
            <span className="text-3xl print:text-xl">🎓</span>
          </div>
          <h3 className="font-serif text-2xl print:text-xl font-bold text-white mb-1 tracking-wide">YOUR 25-YEAR-OLD CHILD</h3>
          <div className="w-12 h-0.5 bg-amber-400/50 mx-auto mb-2 print:mb-1" />
          <p className="text-white/90 text-base print:text-[11px] italic mb-3 print:mb-2 leading-snug">"Natural consequences prepare them for real life"</p>

          {/* Two-column layout for print */}
          <div className="space-y-3 print:space-y-0 print:grid print:grid-cols-2 print:gap-2">
            {/* Why Natural Consequences */}
            <div className="bg-white/10 rounded-xl p-4 print:p-2 text-left">
              <h4 className="text-amber-300 font-bold text-lg print:text-sm mb-2 print:mb-1 flex items-center gap-2">
                <span className="text-xl print:text-sm">💡</span> Why Natural Consequences?
              </h4>
              <div className="space-y-1 text-white/90 text-sm print:text-[9px] leading-tight">
            ...
            <div className="bg-white/10 rounded-xl p-4 print:p-2 text-left">
              <h4 className="text-white font-bold text-lg print:text-sm mb-2 print:mb-1 flex items-center gap-2">
                <span className="text-xl print:text-sm">🧥</span> "I Don't Want a Jacket"
              </h4>
              <div className="bg-white/10 rounded-lg p-3 print:p-1.5 text-white/90 text-sm print:text-[9px] leading-tight">
                <p><strong>Child:</strong> "I don't need a jacket!"</p>
                <p className="mt-1"><strong>Parent:</strong> "Okay, that's your choice."</p>
                <p className="mt-1"><strong>Natural consequence:</strong> They feel cold outside.</p>
                <p className="mt-1 text-amber-300 italic">Tip: Bring the jacket anyway while they're young.</p>
              </div>
            </div>
            ...
            <div className="bg-white/10 rounded-xl p-4 print:p-2 text-left">
              <h4 className="text-white font-bold text-lg print:text-sm mb-2 print:mb-1 flex items-center gap-2">
                <span className="text-xl print:text-sm">🛝</span> Leaving the Playground
              </h4>
              <div className="bg-white/10 rounded-lg p-3 print:p-1.5 text-white/90 text-sm print:text-[9px] leading-tight">
                <p><strong>Situation:</strong> Can't leave with a good attitude</p>
                <p className="mt-1"><strong>Consequence:</strong> We take a break from the playground.</p>
                <p className="mt-1 text-amber-300 italic">At 25: Bad attitude at work = no opportunities.</p>
              </div>
            </div>

            {/* Real World vs Artificial */}
            <div className="grid grid-cols-2 gap-2 print:gap-1">
              <div className="bg-red-500/20 rounded-xl p-3 print:p-1.5 text-left border border-red-400/30">
                <h5 className="text-red-300 font-bold text-sm print:text-[9px] mb-1">❌ Artificial</h5>
                <div className="text-white/80 text-xs print:text-[8px] space-y-0.5 leading-tight">
                  <p>• "Go to your room!"</p>
                  <p>• "Think about what you did"</p>
                  <p>• Unrelated to behavior</p>
                </div>
              </div>
              <div className="bg-green-500/20 rounded-xl p-3 print:p-1.5 text-left border border-green-400/30">
                <h5 className="text-green-300 font-bold text-sm print:text-[9px] mb-1">✅ Natural</h5>
                <div className="text-white/80 text-xs print:text-[8px] space-y-0.5 leading-tight">
          ...
          {/* Faith Element */}
          <div className="mt-3 print:mt-1 pt-2 print:pt-1 border-t border-white/20">
            <div className="flex items-center gap-3 print:gap-2 bg-white/10 rounded-xl p-3 print:p-1.5">
              <img
                src={faithImageMap["jesus-foundation"]}
                alt="God uses natural consequences"
                className="w-12 h-12 print:w-8 print:h-8 rounded-full object-cover border-2 border-amber-300/50 shadow-lg"
              />
              <div className="flex-1 text-left">
                <p className="text-white font-serif text-sm print:text-[9px] italic leading-tight">
                  "A man reaps what he sows."
                </p>
                <p className="text-white/70 text-xs print:text-[8px] mt-0.5">— Galatians 6:7</p>
              </div>
            </div>
          </div>
        </div>
  ...
  if (mantraId === "life-skills-not-chores") {
    return (
      <div className="my-6 print:my-1 flex flex-col items-center">
        <div className="bg-gradient-to-br from-orange-500 to-amber-600 rounded-3xl p-6 print:p-3 shadow-2xl text-center max-w-xl w-full print:max-w-none">
          {/* Icon */}
          <div className="w-16 h-16 print:w-10 print:h-10 mx-auto mb-3 print:mb-1 bg-white/20 rounded-full flex items-center justify-center border-4 border-white/30 shadow-lg">
            <span className="text-3xl print:text-xl">🛠️</span>
          </div>
          <h3 className="font-serif text-3xl print:text-xl font-bold text-white mb-1 tracking-wide">LIFE SKILLS, NOT CHORES</h3>
          <div className="w-12 h-0.5 bg-white/50 mx-auto mb-2 print:mb-1" />
          <p className="text-white/90 text-base print:text-[11px] italic mb-4 print:mb-2 leading-snug">"We're not doing chores—we're learning to be capable adults"</p>
          ...
          <div className="space-y-3 print:space-y-0 print:grid print:grid-cols-2 print:gap-2">
            ...
            <div className="bg-white/20 rounded-xl p-4 print:p-2 text-left">
              <h4 className="text-white font-bold text-lg print:text-sm mb-2 print:mb-1 flex items-center gap-2">
                <span className="text-xl print:text-sm">💡</span> The Mindset Shift
              </h4>
              <div className="space-y-1 text-white/90 text-sm print:text-[9px] leading-tight">
                <p>• I don't "do chores"—I have skills to take care of my home</p>
                <p>• These are tasks every adult needs to live independently</p>
            ...
            <div className="grid grid-cols-2 gap-3 print:gap-1">
              <div className="bg-red-500/30 rounded-xl p-3 print:p-1.5 text-left border border-red-300/30">
                <h5 className="text-red-100 font-bold text-sm print:text-[9px] mb-1 flex items-center gap-1">
                  <span>❌</span> Don't Say
                </h5>
                <div className="text-white/80 text-xs print:text-[8px] space-y-0.5 leading-tight">
                  <p>"Do your chores"</p>
              ...
              <div className="bg-green-500/30 rounded-xl p-3 print:p-1.5 text-left border border-green-300/30">
                <h5 className="text-green-100 font-bold text-sm print:text-[9px] mb-1 flex items-center gap-1">
            ...
            <div className="bg-white/20 rounded-xl p-4 print:p-2 text-left">
              <h4 className="text-white font-bold text-lg print:text-sm mb-2 print:mb-1 flex items-center gap-2">
                <span className="text-xl print:text-sm">💰</span> When They Want Something
              </h4>
              <div className="bg-white/10 rounded-lg p-3 print:p-1.5 text-white/90 text-sm print:text-[9px] leading-tight">
                <p><strong>Child:</strong> "Can I have [toy/game/item]?"</p>
                <p className="mt-1"><strong>Parent:</strong> "What can you contribute around the house to earn money for it?"</p>
                <p className="mt-1 text-amber-200 italic">This teaches: work → reward, like adult life.</p>
              </div>
            </div>
            ...
            <div className="bg-white/20 rounded-xl p-4 print:p-2 text-left">
              <h4 className="text-white font-bold text-lg print:text-sm mb-2 print:mb-1 flex items-center gap-2">
                <span className="text-xl print:text-sm">📋</span> Life Skills to Learn
              </h4>
              <div className="grid grid-cols-2 gap-1 text-white/90 text-sm print:text-[8px] leading-tight">
                <p>🍳 Cooking basics</p>
                <p>🧺 Laundry</p>
                <p>🧹 Cleaning spaces</p>
          ...
          {/* Faith Element */}
          <div className="mt-4 print:mt-2 pt-3 print:pt-1 border-t border-white/30">
            <div className="flex items-center gap-3 print:gap-2 bg-white/20 rounded-xl p-3 print:p-1.5">
              <img
                src={faithImageMap["jesus-foundation"]}
                alt="God equips us for work"
                className="w-14 h-14 print:w-9 print:h-9 rounded-full object-cover border-2 border-white/50 shadow-lg"
              />
              <div className="flex-1 text-left">
                <p className="text-white font-serif text-sm print:text-[9px] italic leading-tight">
                  "Whatever you do, work at it with all your heart, as working for the Lord."
                </p>
                <p className="text-white/70 text-xs print:text-[8px] mt-0.5">— Colossians 3:23</p>
              </div>
            </div>
          </div>
        </div>
  ...
  if (mantraId === "list-of-values") {
    ...
    return (
      <div className="my-2 flex flex-col items-center print-values-list">
        <div className="bg-gradient-to-br from-indigo-50 to-purple-100 rounded-3xl p-5 print:p-3 shadow-xl max-w-3xl w-full border-2 border-indigo-200">
          <div className="text-center mb-3 print:mb-2">
            <div className="w-14 h-14 print:w-10 print:h-10 mx-auto mb-2 print:mb-1 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-full flex items-center justify-center shadow-lg">
              <Star className="w-7 h-7 print:w-5 print:h-5 text-white" />
            </div>
            <h3 className="font-serif text-2xl print:text-xl font-bold text-indigo-800 tracking-wide">LIST OF VALUES</h3>
            <p className="text-indigo-600 italic mt-0.5 text-sm print:text-xs">What matters most to you & your family?</p>
            <div className="w-12 h-0.5 bg-indigo-300 mx-auto mt-2" />
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 gap-2 print:gap-1">
            {values.map((v, i) => (
              <div key={i} className="bg-white/70 rounded-lg p-2 print:p-1.5 border border-indigo-100 text-center flex flex-col items-center">
                <div className={`w-8 h-8 print:w-6 print:h-6 rounded-full bg-gradient-to-br ${v.color} flex items-center justify-center text-white shadow-sm mb-1`}>
                  <span className="[&>svg]:w-4 [&>svg]:h-4 print:[&>svg]:w-3 print:[&>svg]:h-3">{v.icon}</span>
                </div>
                <p className="font-bold text-indigo-800 text-xs print:text-[10px] leading-tight">{v.label}</p>
                <p className="text-indigo-500 text-[10px] print:text-[8px] mt-0 leading-tight">{v.desc}</p>
              </div>
            ))}
          </div>

          {/* Faith Element */}
          <div className="mt-3 print:mt-2 bg-indigo-100/60 rounded-xl p-2.5 print:p-1.5 text-center">
            <p className="text-indigo-700 text-xs print:text-[9px] italic font-serif leading-snug">
              "But the fruit of the Spirit is love, joy, peace, forbearance, kindness, goodness, faithfulness, gentleness and self-control."
            </p>
            <p className="text-indigo-500 text-[10px] print:text-[8px] mt-0.5 font-medium">— Galatians 5:22-23</p>
          </div>
          ...
          <div className="flex items-center justify-between pt-2 border-t border-indigo-200 mt-2">
            ...
            <p className="text-indigo-600 text-[10px] print:text-[8px] font-medium italic">Model Parenting Method</p>
          </div>
        </div>
      </div>
    );
